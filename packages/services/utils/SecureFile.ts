...
export class ValidateSecureFileUploadServices {
    ...
    public static validateFile(file: FileDto): { valid: boolean; error?: string } {
    ...
    public static async validateFiles(files: FileDto[]) {
